...
export default function TeacherLayout({
    ...
    const navItems = [
        ...
        { href: '/teacher/attendance', icon: 'co_present', label: 'Attendance' },
        { href: '/teacher/assignments', icon: 'assignment', label: 'Assignments' },
        { href: '/teacher/grades', icon: 'grade', label: 'Gradebook' },
        { href: '/teacher/announcements', icon: 'campaign', label: 'Announcements' },
            ...
            <div className="flex h-screen bg-gray-50">
                ...
                <div className="flex-1 flex flex-col overflow-hidden">
                    ...
                    <div className="lg:hidden bg-white border-b border-gray-200 px-4 py-3 flex items-center gap-3 sticky top-0 z-30">
                        ...
                        <h1 className="text-lg font-bold text-brand-navy">Teacher Portal</h1>
                    </div>
