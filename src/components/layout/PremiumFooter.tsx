        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="col-span-1">
            <div className="flex items-center gap-3 mb-6">
              ...
              <span className="font-bold text-lg text-white">{settings?.schoolName || 'Regisbridge'}</span>
            </div>
            <p className="text-gray-300 text-sm leading-relaxed mb-6">
              {settings?.motto || 'Empowering students to achieve academic excellence and personal growth since 1974.'}
            </p>
