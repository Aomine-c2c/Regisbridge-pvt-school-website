    ...
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-5">
        <div className="flex justify-between items-center gap-4">
          ...
          <nav className="flex items-center gap-2 sm:gap-4" aria-label="Header controls">
            <LanguageToggle />
            <ThemeToggle />
            <button
              onClick={() => setIsSearchOpen(!isSearchOpen)}
              className="p-2 hover:bg-white/10 rounded-lg transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-[#D4AF37]"
