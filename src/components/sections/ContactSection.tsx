...
export default function ContactSection() {
  ...
  return (
    <section id="contact" className="py-20 md:py-24 bg-gradient-to-b from-gray-50 to-white">
            ...
            <div className="glass-card p-8 rounded-lg shadow-medium mb-10 space-y-6">
              <div className="flex items-start group">
                ...
                <div>
                  ...
                  <p className="text-gray-600 leading-relaxed">{legalInformation.registeredAddress}</p>
                </div>
              </div>
              <div className="flex items-start group">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Director: {legalInformation.alternatePhone}</p>
                  <p className="text-gray-600">School Head: +263 77 909 7410</p>
                  <p className="text-gray-600">Office: {legalInformation.phone}</p>
                </div>
              </div>
              <div className="flex items-start group">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">{legalInformation.email}</p>
                </div>
              </div>
              <div className="flex items-start group">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">Saturday: By appointment</p>
                </div>
              </div>
            </div>
          ...
          <div className="animate-fade-in-delay-400">
            ...
            {submitted ? (
              <div className="glass-card border-l-4 border-green-500 px-6 py-4 rounded-lg animate-fade-in flex items-start shadow-medium card-elevated">
                <CheckCircle className="mr-3 flex-shrink-0 mt-0.5 text-green-600" size={20} />
                <div>
                  <p className="font-semibold mb-1 text-green-700">Message sent successfully!</p>
                  <p className="text-sm text-green-600">Thank you for contacting us. We'll respond within 24 hours.</p>
                </div>
              </div>
              ...
              <div className="glass-card border-l-4 border-red-500 px-6 py-4 rounded-lg animate-fade-in flex items-start shadow-medium">
                <AlertCircle className="mr-3 flex-shrink-0 mt-0.5 text-red-600" size={20} />
                <div>
              ...
              <form onSubmit={handleSubmit} className="glass-card p-8 rounded-lg shadow-strong space-y-6">
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-5 py-3 border rounded-lg focus:outline-none focus:ring-2 transition-all duration-200 glass-card-dark ${
                      formErrors.name && touched.name
                        ? 'border-red-500 focus:ring-red-500 focus:shadow-glow-gold'
                        : 'border-gray-300 focus:ring-[#D4AF37] focus:border-transparent focus:shadow-glow-gold'
                    }`}
                  />
                  {formErrors.name && touched.name && (
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className={`w-full px-5 py-3 border rounded-lg focus:outline-none focus:ring-2 resize-none transition-all duration-200 glass-card-dark ${
